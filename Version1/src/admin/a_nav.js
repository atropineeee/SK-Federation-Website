...
// Create Account
const m_crtbtn = document.querySelector('.m-tbar-side-crtacc');
const m_crtpnl = document.querySelector('.m-add-user-container');
const m_crtfrm = document.querySelector('.m-add-user-form');

m_crtbtn.addEventListener('click', cpcr);

function cpcr() {
    fxt();
    m_crtpnl.classList.add('open');
    m_crtfrm.classList.add('open');
}